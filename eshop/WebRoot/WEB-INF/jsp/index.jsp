			...
			<div id="hotProduct" class="hotProduct clearfix">
					...
					<ul class="tab">
						...
						<ul class="tabContent" style="display: block;">
									<s:set value="hotProducts" id="ps"></s:set>
									<s:iterator value="#ps" id="p">
										<li>
											<a target="_blank" href="product_findDetail.action?pid=<s:property value='#p.pid'/>"><img src="${pageContext.request.contextPath}/<s:property value="#p.image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
										</li>
									</s:iterator>
						</ul>
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
					...
					<ul class="tab">
						 ...
						 <ul class="tabContent" style="display: block;">
									<s:set value="newProduts" id="ns"></s:set>
									<s:iterator value="#ns" id="p">
										<li>
											<a target="_blank" href="product_findDetail.action?pid=<s:property value='#p.pid'/>"><img src="${pageContext.request.contextPath}/<s:property value="#p.image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>
										</li>
									</s:iterator>
						</ul>
						<ul class="tabContent" style="display: none;">
