...
<script type="text/javascript">
	...
	function checkRegister() {
		...
		if (password != rePassword) {
			$("repwd_msg").innerHTML = "两次输入的密码不一致！";
			$("rePassword").focus();
			return false;
		}
		...
		if (!emailReg.test(email)) {
			$("email_msg").innerHTML = "不是有效的邮箱格式！";
			$("email").focus();
			return false;
		}
		var phone = $("phone").value;
		if (phone.length != 11) {
			$("phone_msg").innerHTML = "不是正确的手机号码！";
			$("phone").focus();
			return false;
		}
	...
	function isValid() {
		...
		//发送请求
		xmlhttp.open("GET", "user_validateUsername.action?username="
				+ username + "&time=" + new Date().getTime(), true);
		xmlhttp.send();
	}
	...
	function change(){
		var checkImg = $("verifyImage");
		checkImg.src = "user_verifycode.action?time" + new Date().getTime();
	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" method="post" action="${ pageContext.request.contextPath }/register.action"
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="user.username"
										class="text" maxlength="20" onblur="return isValid()"> <span
											id="uname_msg" style="color:red;"></span></td>
								</tr>
								<tr>
									...
									<td><input type="password" id="password" name="user.password"
										class="text" maxlength="20" autocomplete="off"> <span
											id="pwd_msg" style="color:red;"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>确认密码:</th>
									<td><input type="password" name="rePassword"
										id="rePassword" class="text" maxlength="20" autocomplete="off">
											<span id="repwd_msg" style="color:red;"></span></td>
								</tr>
								<tr>
									<th>性别:</th>
									<td><span class="fieldSet"> <label> <input
												type="radio" name="userdetail.gender" value="1">男 </label> <label>
												<input type="radio" name="userdetail.gender" value="0">女 
										</label>
									</span></td>
								</tr>
								<tr>
									<th>姓名:</th>
									<td><input type="text" name="userdetail.truename" class="text"
										maxlength="200"></td>
								</tr>
								<tr>
									<th>出生日期:</th>
									<td><input type="text" name="userdetail.birthday" id="birthday" class="text"
										onfocus="WdatePicker({el:'birthday'});">
									</td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><input type="text" id="email" name="userdetail.email"
										class="text" maxlength="200"> <span id="email_msg"
											style="color:red;"></span></td>
								</tr>
								<tr>
									<th>地址:</th>
									<td><input type="text" name="userdetail.address" class="text"
										maxlength="200"></td>
								</tr>
								<tr>
									<th>手机号码:</th>
									<td><input type="text" name="userdetail.phone" id="phone"
										class="text" maxlength="200"> <span id="phone_msg"
											style="color:red;"></span></td>
								</tr>
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											maxlength="4" autocomplete="off"><img
												src="user_verifycode.action" id="verifyImage"
