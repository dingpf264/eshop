...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010101','0101','用户管理','${pageContext.request.contextPath}/adminUser_findAllByPage.action?currentPage=1','','mainFrame');
		...
		d.add('010202','0102','添加一级分类','${pageContext.request.contextPath}/admin/category/add.jsp','','mainFrame');
		...
		d.add('010302','0103','添加二级分类','${pageContext.request.contextPath}/adminCategorySecond_addPage.action','','mainFrame');
		...
		d.add('010403','0104','添加商品','${pageContext.request.contextPath}/adminProduct_addPage.action','','mainFrame');
