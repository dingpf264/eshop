		...
		<DL>
			...
			<DD id=user_main>
				<UL>
					...
					<form id="loginForm" action="seller_loginSeller.action" method="post" target="_parent">
						<LI class=user_main_c>
							<DIV class=user_main_box>
								<UL>
									<LI class=user_main_text>用户名：</LI>
									<LI class=user_main_input><INPUT class=TxtUserNameCssClass
										id=TxtUserName maxLength=30 name="seller.username"></LI>
								</UL>
								<UL>
									<LI class=user_main_text>密&nbsp;&nbsp;&nbsp;&nbsp;码：</LI>
									<LI class=user_main_input><INPUT class=TxtPasswordCssClass
										id=TxtPassword type=password name="seller.password"></LI>
								</UL>
							</DIV>
						</LI>
